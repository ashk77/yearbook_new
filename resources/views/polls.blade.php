                    ...
                    <div class="col-xl-12 mx-auto">
                        <div class="cta-inner text-center rounded">
                            ...
                            <p class="mb-0">Who is the Maggu of your batch?<br>
                                ...
                                Vote for them and they'll be felicitated on Alvida!
                            </p>
                            <br>
                            <!-- that’s all folks! -->
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-9 mx-auto">
                        <div class="text-center rounded">
                            ...
                            <ul>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/1')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">1. Arnold Schwarzenegger of the batch</label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/2')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">2. Friendzoned of the batch</label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/3')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">3. Tom Cruise of the Batch</label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/4')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">4. Maggu of the Batch</label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/5')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">5. Charlie Chaplin of the batch 
                                            </label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/6')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">6. Zero attendance wala of the batch
                                            </label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/7')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">7. Bandi Stud </label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/8')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">8. Tempo Of The Batch</label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/9')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">9. Mr. Spring Fest
                                            </label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/10')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">10. Ms. Spring Fest
                                            </label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/11')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">11. Voice Of the Batch
                                            </label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/12')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">12. Khadoos of the batch
                                            </label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/13')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">13. Tharki of the batch
                                            </label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/14')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">14. Neta of the Batch 
                                            </label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/15')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">15. Prodigy of the batch
                                            </label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/16')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">16. Tindernath of the Batch
                                            </label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/17')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">17. Michael Jackson of the Batch
                                            </label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/18')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">18. 
                                            Wikipedia of the batch
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/19')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">19. Marilyn Monroe of the Batch 
                                            </label>
                                ...
                                <hr>
                                <li style="list-style: none;">
                                    <form action="{{url('polls/20')}}" method="POST" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <div class="form-group" >
                                            <label class="control-label col-sm-2" for="polls">20. Chandler of the batch
                                            </label>
