    ...
    <form method="post" action="{{ url('login') }}" class="form main-title center">
      ...
      <div class="row" style="margin-bottom: 0px;"> <br> <br> 
        ...
        <div class="input-field col s12 l6 m12 " >                   
          ...
          <label for="rollno"><h5 style="font-size: 140%;  color: #004d33;margin-top: -10px;">Roll Number (14THXXXXX)</h5></label>
        </div>
        <div class="input-field col s12 l6 m12 ">                   
          <input name="password" id="dob" placeholder="Password(if changed)" type="text" style="margin-top: 5px;" required>
          <label for="dob" class="control-label"><h5 style="font-size: 140%; color: #004d33;margin-top: -10px;">Date of Birth (dd-mm-yyyy) or Password(if changed)</h5></label>
        </div>
      </div>
      <div class="row">
